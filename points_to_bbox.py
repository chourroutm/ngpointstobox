...
def convert_points_to_bbox(state: neuroglancer.ViewerState, keep_points_layer: bool = False, annotation_layer_suffix: str = "_bbox"):
    for current_layer in state.layers:
        ...
        new_layer.annotations.append(
            neuroglancer.AxisAlignedBoundingBoxAnnotation(
                    ...
                    point_a= _bounding_box(all_points)[0],
                    point_b= _bounding_box(all_points)[1],
                )
        )
